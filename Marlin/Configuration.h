...
#define STRING_CONFIG_H_AUTHOR "(Pedro Rocha, A20M config)" // Who made the changes.
...
//#define MIXING_EXTRUDER
  ...
  #define MIXING_STEPPERS 1        // Number of steppers in your mixing extruder
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A20M [@thinkyhead]
    ...
    #define DEFAULT_Kp_LIST {  19.31,19.31 }
    #define DEFAULT_Ki_LIST {   1.04, 1.04 }
    #define DEFAULT_Kd_LIST { 89.80, 89.80 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 68.36   // 175.68 189.95
  #define DEFAULT_bedKi 8.60    //  34.59  37.40
  #define DEFAULT_bedKd 362.16   // 223.07 241.19
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.08, 80, 400, 392 }
